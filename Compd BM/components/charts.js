window.TireCharts = (function() {
  ...
  function updateCorrelationBadge(r) {
    ...
    valElem.innerHTML = `<span style="font-size: 1rem; font-weight: 700; color: var(--text-dark);">${rText}</span> <span style="font-size: 0.75rem; font-weight: 600; color: ${color}; margin-left: 6px;">(${desc})</span>`;
    badge.style.borderColor = color;
    badge.style.color = 'var(--text-dark)';
    badge.style.background = `linear-gradient(135deg, var(--card-bg), ${bg})`;
  }

...
const TIRE_STRATEGY_DB = {
    ...
    Bridgestone: {
        ...
        marketing: {
            fact: "브리지스톤은 '프리미엄 주행 성능과 지속가능성의 완벽한 공존'을 미디어 광고 전면에 강조하고 있습니다. 타이어 중량 축소를 통해 연비와 젖은 노면 접지력을 동시에 확보한 친환경 럭셔리 드라이빙 가치를 적극 전달하고 있습니다.",
    ...
    Continental: {
        ...
        chartLabels: ["지능형 무선 센서 섀시 연계", "민들레 고무 Taraxagum 상용화", "고온/젖은 노면 복합 정밀 제동 소재", "전기차 최적 강성 보강 패키지", "타이어 내측 저온 융착 가동 공정"],
